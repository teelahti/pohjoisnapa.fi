  ...
  >
    <div id="isottukijat">
      ...
      >
        ...
        vähittäiskauppa, jonka tuotevalikoima koostuu n. 150 000:sta "non-food"
        artikkelista. Yrityksen perusti Juha Kärkkäinen vuonna 1988. Nykyään
        Kärkkäisellä on isot tavaratalot sekä Ylivieskassa että Oulussa.
        Tuotevalikoimaa kehitetään jatkuvasti vastaamaan asiakkaiden tarpeita.
      </Big>
      <Big
        ...
        img={alexandria}
      >
        Alexandria on Suomen johtava säästämiseen ja sijoittamiseen erikoistunut
        asiakaspalveluyhtiö. Tavoitteemme on kasvattaa asiakkaidemme
        varallisuutta. Jatkuvan menestyksemme ja kehityksemme on mahdollistanut
        kyky ennakoida asiakkaidemme muuttuvia tarpeita ja toiveita. Alexandria
        on yksityinen suomalainen yhtiö, jonka vakavaraisuus on AAA.
        Asiakkaitamme (yli 24.000) palvelee valtakunnallisesti n.150 henkilöä,
        11 toimistoamme muodostavat kattavan verkoston ympäri maata. Alexandria
        Manager Funds -omaisuudenhoitorahastojen hallinnoitavat varat ovat yli
        200 miljoonaa euroa. Vuosi 2006 on menestyksekkään toimintahistoriamme
        kymmenes.
      </Big>
      <div
        style={{
    ...
    <div id="logotukijat">
      ...
      <Small name="Ruskovilla" to="http://www.ruskovilla.fi" img={ruskovilla} />
      ...
      <Small name="Polartherm" to="http://www.polartherm.fi" img={polartherm} />
