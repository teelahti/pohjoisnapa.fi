<%@ Page Language="C#" MasterPageFile="~/Pohjoisnapa.master" AutoEventWireup="true"
	Inherits="Varusteet" Title="Pohjoisnapa 2006 - varusteet" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="Varusteet.aspx.cs" %>

<asp:Content ID="ContentVarusteet" ContentPlaceHolderID="MainContent" runat="Server">
	<p class="poikkeus2">
		<asp:Image runat="server" ID="OtsikkoKuva" ImageUrl="~/kuvat/linkit/otsikot/otsikko-varusteet.gif" AlternateText="Varusteet" meta:resourcekey="OtsikkoKuvaResource1" /></p>
	<h4>
		<asp:Localize ID="otsikko" runat="server" Text="Varusteet" meta:resourcekey="otsikko" /></h4>
